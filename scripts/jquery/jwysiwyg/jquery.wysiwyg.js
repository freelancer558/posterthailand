...
(function ($)
{
        ...
        $.fn.wysiwyg.defaults = {
                ...
                formImageHtml:'<form class="wysiwyg"><fieldset><legend>Insert Image</legend><label>Image URL: <input type="text" name="url" value="http://" style="width:275px;"/></label><label>Image Title: <input type="text" name="imagetitle" value="" style="width:275px;"/></label><label>Image Description: <input type="text" name="description" value="" style="width:275px;"/></label><input type="submit" class="button" value="Insert Image" /> <input type="reset" value="Cancel" /></fieldset></form>',
                formWidth: 440,
                formHeight: 270,
